...
ActiveRecord::Schema.define(version: 2023_04_17_073854) do
  ...
  create_table "shipping_informs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buy_id"], name: "index_shipping_informs_on_buy_id"
  end
  ...
  add_foreign_key "shipping_informs", "buys"
end
