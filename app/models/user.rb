class User < ApplicationRecord
  ...
  validates :last_name, presence: true, format: { with: /\A[ぁ-んァ-ン一-龠々]+\z/, message: 'は全角で入力してください' }
  validates :first_name, presence: true, format: { with: /\A[ぁ-んァ-ン一-龠々]+\z/, message: 'は全角で入力してください' }
